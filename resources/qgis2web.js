...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32619',
            extent: [432980.553000, 2073548.546806, 433772.330100, 2074109.867000],
            units: 'm'})
    })
});
...
map.getView().fit([433169.286245, 2073644.937109, 433593.807217, 2073960.616482], map.getSize());
